...
// File: contracts/AodPoolInitializable.sol

pragma solidity 0.6.12;

contract AodPoolInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the smart chef factory
    address public AOD_POOL_FACTORY;
    ...
    function initialize(
        ...
        require(msg.sender == AOD_POOL_FACTORY, "Not factory");
...
// File: contracts/AodPoolFactory.sol

pragma solidity 0.6.12;

contract AodPoolFactory is Ownable {
    event NewAodPoolContract(address indexed smartChef);
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(AodPoolInitializable).creationCode;
        bytes32 salt =
            keccak256(
        ...
        AodPoolInitializable(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
        ...
        emit NewAodPoolContract(smartChefAddress);
    }
}
